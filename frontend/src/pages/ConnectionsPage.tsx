    ...
    <div className="max-w-6xl mx-auto px-4 py-8">
      ...
      <nav className="mb-6">
        <ol className="flex items-center gap-2 text-sm">
          ...
          <li className="text-stone-800">Connections</li>
        </ol>
      </nav>

      {/* Header */}
      <div className="mb-8">
        <h1 className="text-2xl font-bold text-stone-800">External Connections</h1>
      ...
      {/* Help Section */}
      <div className="mt-12 bg-white rounded-lg border border-stone-200 p-6">
        <h2 className="text-lg font-medium text-stone-800 mb-4">How it works</h2>
        <div className="grid md:grid-cols-3 gap-6">
          <div>
            ...
            <h3 className="font-medium text-stone-800 mb-1">1. Connect a Platform</h3>
          ...
          <div>
            ...
            <h3 className="font-medium text-stone-800 mb-1">2. Select Channels</h3>
            <p className="text-sm text-stone-500">
          ...
          <div>
            ...
            <h3 className="font-medium text-stone-800 mb-1">3. Use in Configs</h3>
            <p className="text-sm text-stone-500">
