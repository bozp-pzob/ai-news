...
function App({
  ...
  return (
    <div className={containerClass}>
      {/* Full-width Toolbar - only show in legacy mode */}
      {!platformMode && (
        <div className="h-12 bg-stone-900 border-b border-stone-700 flex items-center px-4 flex-shrink-0 justify-between">
