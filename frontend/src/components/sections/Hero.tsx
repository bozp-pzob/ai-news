        ...
        <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-16">
          <div className="relative max-w-xl">
            ...
            <div className="animate-fadeIn" style={{ animationDelay: '0.4s', opacity: 0 }}>
              <p className="text-base sm:text-lg md:text-xl text-stone-600 leading-relaxed max-w-md mb-5 sm:mb-8">
                Plant the seeds of your data, tend them with AI, and harvest insights that grow your community.
              </p>
            </div>

            {/* CTAs */}
            <div className="flex flex-wrap gap-3 sm:gap-4 animate-fadeIn" style={{ animationDelay: '0.55s', opacity: 0 }}>
              <button 
                onClick={handleLaunchApp}
                className="group inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-xl text-sm sm:text-base font-semibold h-11 sm:h-12 px-6 sm:px-8 bg-emerald-600 text-white hover:bg-emerald-700 shadow-lg shadow-emerald-600/25 hover:shadow-emerald-600/40 transition-all duration-200 hover:-translate-y-0.5"
              >
                Get Started Free
